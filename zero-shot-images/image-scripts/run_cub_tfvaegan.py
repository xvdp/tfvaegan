...
if opt.transductive:
    ...
    --gzsl --manualSeed 3483 --encoded_noise --preprocessing --cuda --image_embedding res101 --class_embedding att \
    --nepoch 600 --ngh 4096 --ndh 4096 --lr 0.0001 --classifier_lr 0.001 --lambda1 10 --critic_iter 5 --dataroot data --dataset CUB \
    --nclass_all 200 --batch_size 64 --nz 312 --latent_size 312 --attSize 312 --resSize 2048 --syn_num 300 \
    --recons_weight 0.01 --a1 1 --a2 1 --feed_lr 0.00001 --dec_lr 0.0001 --feedback_loop 2''')
...
if opt.finetuning:
    ...
    if opt.inductive:
        ...
        --nepoch 300 --ngh 4096 --ndh 4096 --lr 0.0001 --classifier_lr 0.001 --lambda1 10 --critic_iter 5 --dataroot data --dataset CUB \
        --nclass_all 200 --batch_size 64 --nz 312 --latent_size 312 --attSize 312 --resSize 2048 --syn_num 300 --outf checkpoint_camera_ready/ \
        --outname cub_tfvaegan_inductive_finetuning --feed_lr 0.0001 --recons_weight 0.1 --loop_count 2 --a1 1 --a2 1 \
        --lambda_mult 1.1 --zsl_dec --cls2fast --use_mult_rep --dec_lr 0.0001''')
    ...
    #transductive FINETUNING
        ...
        --nepoch 300 --ngh 4096 --ndh 4096 --lr 0.0001 --classifier_lr 0.001 --lambda1 10 --critic_iter 5 --dataroot data --dataset CUB \
        --nclass_all 200 --batch_size 64 --nz 312 --latent_size 312 --attSize 312 --resSize 2048 --syn_num 300 --outf checkpoint_camera_ready/ \
        --outname cub_tfvaegan_transductive_finetuning --feed_lr 0.0001 --recons_weight 0.1 --loop_count 2 --a1 1 --a2 1 \
        --lambda_mult 1.1 --zsl_dec --cls2fast --use_mult_rep --dec_lr 0.0001''')
