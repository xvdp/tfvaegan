...
if opt.inductive:
    ...
    --classifier_lr 0.0005 --syn_num 400 --nclass_all 717 --dataroot data --outf checkpoint_camera_ready/ \
    --recons_weight 0.01 --a1 0.1 --a2 0.01 --loop_count 2 --cls2fast --zsl_dec --use_mult_rep \
    --feed_lr 0.0001 --lambda_mult 1.1 --outname sun_tfvaegan_indcutive''')
...
if opt.transductive:
    ...
    --classifier_lr 0.0005 --syn_num 400 --nclass_all 717 --dataroot data --outf checkpoint_camera_ready/ \
    --recons_weight 0.01 --a1 0.1 --a2 0.01 --loop_count 2 --cls2fast --zsl_dec --use_mult_rep \
    --feed_lr 0.0001 --lambda_mult 1.1 --dec_lr 0.0001 \
    --outname sun_tfvaegan_transductive''')
...
if opt.finetuning:
    ...
    if opt.inductive:
        ...
        --classifier_lr 0.0005 --syn_num 400 --nclass_all 717 --dataroot data --outf checkpoint_camera_ready/ --outname sun_vae_dec \
        --recons_weight 1.0 --dec_lr 0.00001 --a1 0.1 --a2 0.01 --loop_count 2 --lr 0.0001 --cls2fast --zsl_dec --use_mult_rep --feed_lr 0.00001 \
        --lambda_mult 1.1 --outname sun_tfvaegan_inductive_finetuning''')
    ...
    if opt.transductive:
        ...
        --classifier_lr 0.0005 --syn_num 400 --nclass_all 717 --dataroot data --outf checkpoint_camera_ready/ --outname sun_vae_dec \
        --recons_weight 1.0 --dec_lr 0.00001 --a1 0.1 --a2 0.01 --loop_count 2 --lr 0.0001 --cls2fast --zsl_dec --use_mult_rep --feed_lr 0.00001 \
        --lambda_mult 1.1 --outname sun_tfvaegan_transductive_finetuning''')